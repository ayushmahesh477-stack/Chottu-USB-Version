@echo off
title Chottu AI - Multi-Model Setup
color 0E

echo ===================================================
echo           CHOTTU AI - USB SETUP             
echo ===================================================
echo.
...
echo.
echo ===================================================
echo     SETUP COMPLETE! Chottu is ready to go!            
echo ===================================================
echo.
echo To start Chottu AI, double-click start-windows.bat
echo.
pause